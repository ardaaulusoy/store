...
function martfury_customize_settings() {
	...
	$fields = array(
		...
		'header_bg_color'                         => array(
			...
			'js_vars'         => array(
				array(
					'element'  => '.topbar, .site-header, .header-layout-5 .site-header, .header-layout-5 .topbar, .header-layout-5 .site-header .main-menu',
		...
		'header_text_color'                       => array(
			...
			'js_vars'         => array(
				array(
					'element'  => '.topbar, .topbar a, .site-header:not(.minimized) .extras-menu > li > a,.header-layout-5 .site-header .header-logo .products-cats-menu .cats-menu-title,.header-layout-5 .site-header .extras-menu > li > a,.header-layout-1 .mf-currency-widget .current:after',
					'property' => 'color',
				),
				array(
					'element'  => '.header-layout-1 .site-header .primary-nav > ul > li > a, .header-layout-1 .site-header .products-cats-menu .cats-menu-title .text, .header-layout-1 .site-header .products-cats-menu .cats-menu-title',
					'property' => 'color',
				),
				array(
					'element'  => '.header-layout-5 .topbar a, .header-layout-5 .topbar, .header-layout-5 .site-header .primary-nav>ul>li>a, .header-layout-5 .topbar .mf-currency-widget .current:after',
					'property' => 'color',
				),
			),
			'active_callback' => array(
		...
		'header_hover_color'                      => array(
			'type'            => 'color',
			'label'           => esc_html__( 'Header Hover Color', 'martfury' ),
			'default'         => '',
			'section'         => 'header_skin',
			'priority'        => 20,
			'choices'         => array(
			...
			'js_vars'         => array(
				array(
					'element'  => '.site-header .primary-nav > ul > li > a:hover, .topbar a:hover, .topbar .mf-currency-widget .current:hover',
					'property' => 'color',
				),
				array(
					'element'  => '.header-layout-1 .site-header .primary-nav > ul > li.current-menu-parent > a, .header-layout-1 .site-header .primary-nav > ul > li.current-menu-item > a, .header-layout-1 .site-header .primary-nav > ul > li.current-menu-ancestor > a, .header-layout-1 .site-header .primary-nav > ul > li > a:hover',
					'property' => 'color',
				),
				array(
					'element'  => '.header-layout-5 .topbar a:hover, .header-layout-5 .site-header .primary-nav>ul>li>a:hover, .header-layout-5 .topbar .mf-currency-widget .current:hover',
					'property' => 'color',
				),

				array(
					'element'  => '.header-layout-5 .site-header .primary-nav > ul > li.current-menu-parent > a, .header-layout-5 .site-header .primary-nav > ul > li.current-menu-item > a, .header-layout-5 .site-header .primary-nav > ul > li.current-menu-ancestor > a',
					'property' => 'color',
				),
			),
			'active_callback' => array(
		...
		'header_border_color'                     => array(
			'type'            => 'color',
			'label'           => esc_html__( 'Header Border Color', 'martfury' ),
			'default'         => '',
			'section'         => 'header_skin',
			'priority'        => 20,
			'choices'         => array(
			...
			'js_vars'         => array(
				...
				array(
					'element'  => '.topbar .widget:after, .header-layout-5 .topbar .widget:after',
					'property' => 'background-color',
				),
			),
			'active_callback' => array(
		...
		'show_badges'                             => array(
			'type'        => 'toggle',
			'label'       => esc_html__( 'Show Badges', 'martfury' ),
			'section'     => 'shop_badge',
			'default'     => 0,
			'priority'    => 20,
			'description' => esc_html__( 'Check this to show badges on every products.', 'martfury' ),
		),
		'badges'                                  => array(
			'type'            => 'multicheck',
