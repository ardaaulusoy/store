...
if ( ! function_exists( 'martfury_footer_recently_viewed' ) ) :
	function martfury_footer_recently_viewed() {
		...
		if ( $layout == '1' ) {
			...
			echo '<div class="mf-recently-products layout-1 footer-recently-viewed load-ajax' . esc_attr( $pt_class ) . '" id="footer-recently-viewed"><div class="mf-loading"></div></div>';
		} else {
			...
			$atts['title'] = '';
			echo '<div class="mf-recently-products footer-recently-viewed" id="footer-recently-viewed"><div class="mf-loading"></div></div>';
			echo '</div>';
		}
	}
endif;
