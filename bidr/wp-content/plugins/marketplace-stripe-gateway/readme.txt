...
Tags: Marketplace stripe gateway, wcmp stripe gateway, stripe payment, stripe commission, wc marketplace, wc market place, vendor, vendors, vendor system, market place, wcmp shipping, multivendor, multi vendor, multi seller
...
== Screenshots ==
1. Enable woocommerce stripe from woocommerce payment settings.
2. Enable WC Marketplace stripe connect from payment settings.
3. Configure stripe client id and redirect URI in WCMp payment stripe connect.
4. Stripe API keys.
5. Stripe redirect URI.
6. Vendor Connect: connect vendor account with stripe connect.
7. Vendor Disconnect: Remove vendor account to the admin's stripe connected account list.

== Changelog ==

= 1.0.9 =
* Fixed: Vendor dashboard stripe connect issue.
* Updated: Language file

= 1.0.8 =
* Added: Support WCMp 3.0.
* Updated: Language file
